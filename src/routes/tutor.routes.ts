...
import { authMiddleware, blockCheckMiddleware, deletedCheckMiddleware } from "../config/middleware";

const router = Router();

router.post("/add-update-demos", authMiddleware,blockCheckMiddleware,deletedCheckMiddleware,(req, res) => {
  /*
...
router.post("/get-demos", authMiddleware,blockCheckMiddleware,deletedCheckMiddleware,(req, res) => {
  /*
    #swagger.tags = ['8.Tutor']
