...
router.post("/add-update-demos", middleware_1.authMiddleware, middleware_1.blockCheckMiddleware, middleware_1.deletedCheckMiddleware, (req, res) => {
    /*
...
router.post("/get-demos", middleware_1.authMiddleware, middleware_1.blockCheckMiddleware, middleware_1.deletedCheckMiddleware, (req, res) => {
    /*
      #swagger.tags = ['8.Tutor']
...
router.post("/get-likes-about", (req, res) => {
    ...
    */
    return tutor_controller_1.TutorController.getReviewsAboutTutor(req, res);
});
