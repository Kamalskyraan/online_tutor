...
exports.blockCheckMiddleware = exports.authMiddlewareForDemos = exports.authMiddleware = void 0;
...
const authMiddlewareForDemos = (req, res, next) => {
    try {
        const authHeader = req.headers.authorization;
        if (!authHeader || !authHeader.startsWith("Bearer ")) {
            return (0, helper_1.sendResponse)(res, 200, 2, {}, "Access denied. No token provided", []);
...
exports.authMiddlewareForDemos = authMiddlewareForDemos;
