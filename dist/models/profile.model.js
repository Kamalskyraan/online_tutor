...
class ProfileModel {
    ...
    async fetchUserProfileData(user_id) {
        const [rows] = await (0, helper_1.executeQuery)(`SELECT u.user_id , u.user_name ,u.profile_img,  u.gender , u.country_code  , u.mobile , u.email , u.district , u.state , u.pincode , u.add_mobile , u.primary_num , u.country , u.address, u.area ,u.self_about,  t.tutor_id , t.represent  , t.stream_id ,t.tutor_exp , es.id as stream_id , es.edu_id , es.name stream_name , el.id as edu_level_id , el.name as edu_name, el.board ,cy.currency 
      FROM users u LEFT JOIN tutor t ON t.user_id = u.user_id 
